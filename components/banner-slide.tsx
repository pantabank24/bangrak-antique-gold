  ...
  const banners = [
    {
      id: 1,
      title: "บางรัก แอนทีค",
      subtitle: "รับเช่าพระเครื่อง-พระบูชา รับซื้อของเก่าของโบราณ และกระเพาะปลาเก่า",
        ...
        <div className=" flex w-auto rounded-full">
          <Marquee className=" text-sm" pauseOnHover pauseOnClick>
            <span className="font-bold  text-sm ml-3 bg-gradient-to-b from-yellow-100 to-yellow-500 bg-clip-text text-transparent">
              ...
              น้ำหนักทอง) = ราคาทองที่จะได้รับ มีหน้าร้านตั้งอยู่ใจกลางบางรัก
              เดินทางสะดวก ตรวจเช็คต่อหน้า จ่ายเงินสดทันทีทางร้านยินดีดูแลให้ครับ
            </span>
          </Marquee>
        </div>
      </div>
