    ...
    <div className="min-h-screen flex flex-col items-center">
      ...
      <div className="flex flex-col items-center md:w-full md:px-5 xl:w-1/2">
        ...
        <div className="grid lg:flex grid-cols-2 gap-y-2 gap-x-2 px-2 my-5 justify-start">
          <div className="flex flex-col h-24 items-center backdrop-blur-xl border border-white/20 bg-gradient-to-b from-black/90 to-[#C3A88F] rounded-3xl px-2 pt-2">
        ...
        <div className="grid grid-cols-5 md:grid-cols-10 gap-x-2 gap-y-2 w-full px-2">
          {goldList.map((item) => (
            ...
            >
              <div className="backdrop-blur-xl border border-white/20 bg-gradient-to-b from-black/90 to-[#C3A88F] w-full rounded-full flex items-center justify-center text-sm text-yellow-400">
