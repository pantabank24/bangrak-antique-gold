    ...
    <div>
      ...
      <div className="relative flex w-full py-16 bg-white/5 mt-10 flex-col items-center px-5">
        ...
        <span className=" mb-10 bg-gradient-to-b from-white to-gray-500 bg-clip-text text-transparent font-bold ">
          ข่าวสารประชาสัมพันธ์จาก บางรัก แอนทีค
        </span>
        ...
        <div className=" w-full lg:w-1/2 mt-20 md:mt-32  flex items-center justify-center flex-col">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3875.767954462677!2d100.51847409999999!3d13.732493900000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e298d780f2c437%3A0xb3ddd1f45bde2c9e!2z4Lia4Liy4LiH4Lij4Lix4LiBIOC5geC4reC4meC4l-C4teC4hA!5e0!3m2!1sen!2sth!4v1784126123654!5m2!1sen!2sth"
            width="600"
            height="450"
            loading="lazy"
