  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300     ${isTransparent
        ? isScrolled
          ? "bg-[#C3A88F]/80 backdrop-blur-lg shadow-lg border-b border-yellow-500"
          : "bg-transparent"
        : "bg-[#C3A88F]/80 backdrop-blur-lg shadow-lg border-b border-yellow-500"
        }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
              ...
              isScrolled ? (
                <div className=" flex flex-row items-center">
                  ...
                  <div className=" flex flex-col">
                    <span className="font-bold  text-xl ml-3 bg-gradient-to-b from-yellow-100 via-yellow-400 to-yellow-600 bg-clip-text text-transparent">
                      บางรัก แอนทีค
                    </span>
                    <span className="font-bold  text-xs ml-3 mt-[-5] bg-gradient-to-b from-yellow-100 to-yellow-600 bg-clip-text text-transparent">
                      รับเช่าพระเครื่อง-พระบูชา ของเก่าโบราณ
                    </span>
                  </div>
                </div>
              ) : null
          ...
          <div className="flex items-center gap-4 bg-white/20  backdrop-blur-sm border border-white/20 px-3 py-1 rounded-full">
            <a
              href="https://web.facebook.com/profile.php?id=61567928181159&_rdc=1&_rdr"
            ...
            <a
              href="https://page.line.me/buybangrak"
              className="w-8 h-8 flex items-center justify-center rounded-full  hover:bg-white/20 transition-colors"
              target="_blank"
              rel="noopener noreferrer"
            >
